...
NestJS (Puerto 4000): Gestiona la lógica de negocio, usuarios, playlists, caché en RAM e historial.

Media Service (Puerto 5000): Consume de forma local la pasarela de extracción multimedia tunelizada.
...
Para purgar variables de entorno residuales en la memoria del gestor de procesos ejecuta:
